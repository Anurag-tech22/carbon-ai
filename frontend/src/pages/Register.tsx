...
import { Leaf, Lock, User, Mail, ArrowRight, AlertCircle } from 'lucide-react';
import { motion } from 'framer-motion';

const Register = () => {
  // Remove pre-filled credentials for real security
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-950 p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden opacity-20">
        <div className="absolute top-1/4 right-1/4 w-64 h-64 bg-primary-500 rounded-full mix-blend-screen filter blur-[100px] animate-pulse"></div>
        <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-blue-500 rounded-full mix-blend-screen filter blur-[120px] animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-gray-400 text-sm mt-1">Create an account to start your journey</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label htmlFor="email" className="block text-sm font-medium text-gray-400 mb-1.5 ml-1">Email</label>
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
          ...
          >
            {isLoading ? 'Creating Account...' : <>Sign Up <ArrowRight size={18} className="ml-2" /></>}
          </button>
        </form>
